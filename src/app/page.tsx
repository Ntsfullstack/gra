      ...
      <div className={`relative z-10 min-h-screen p-4 sm:p-8 transition-all duration-1000 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative mt-12">
            ...
            <div className="relative bg-black border-4 border-cyan-400 rounded-2xl overflow-hidden shadow-2xl">
              {/* Animated scan lines */}
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-cyan-400/20 to-transparent" style={{
                backgroundSize: '100% 200%',
                animation: 'scan 4s linear infinite'
              }}></div>

              {/* Diagonal light sweep */}
              <div className="absolute inset-0 bg-gradient-to-br from-transparent via-purple-500/10 to-transparent" style={{
